...
// HasCompanyUsers applies the HasEdge predicate on the "company_users" edge.
func HasCompanyUsers() predicate.Company {
...
// HasCompanyUsersWith applies the HasEdge predicate on the "company_users" edge with a given conditions (other predicates).
func HasCompanyUsersWith(preds ...predicate.CompanyUser) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := newCompanyUsersStep()
...
func HasFolders() predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasFoldersWith(preds ...predicate.Folder) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := newFoldersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasDocumentsWith(preds ...predicate.Document) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
...
func HasTags() predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTagsWith(preds ...predicate.Tag) predicate.Company {
	return predicate.Company(func(s *sql.Selector) {
		step := newTagsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
