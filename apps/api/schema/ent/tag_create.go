...
func (_c *TagCreate) SetCompanyID(v uuid.UUID) *TagCreate {
...
func (_c *TagCreate) SetCompany(v *Company) *TagCreate {
	return _c.SetCompanyID(v.ID)
}

// AddDocumentTagIDs adds the "document_tags" edge to the DocumentTag entity by IDs.
func (_c *TagCreate) AddDocumentTagIDs(ids ...uuid.UUID) *TagCreate {
...
func (_c *TagCreate) check() error {
	...
	if len(_c.mutation.CompanyIDs()) == 0 {
		return &ValidationError{Name: "company", err: errors.New(`ent: missing required edge "Tag.company"`)}
	}
	return nil
}
