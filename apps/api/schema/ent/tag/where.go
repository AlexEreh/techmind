...
func CompanyID(v uuid.UUID) predicate.Tag {
...
func HasCompanyWith(preds ...predicate.Company) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := newCompanyStep()
