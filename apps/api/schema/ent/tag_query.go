...
func (_q *TagQuery) QueryCompany() *CompanyQuery {
...
func (_q *TagQuery) QueryDocumentTags() *DocumentTagQuery {
...
func (_q *TagQuery) WithCompany(opts ...func(*CompanyQuery)) *TagQuery {
	query := (&CompanyClient{config: _q.config}).Query()
...
func (_q *TagQuery) WithDocumentTags(opts ...func(*DocumentTagQuery)) *TagQuery {
	query := (&DocumentTagClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tag, error) {
	...
	if query := _q.withCompany; query != nil {
		if err := _q.loadCompany(ctx, query, nodes, nil,
			func(n *Tag, e *Company) { n.Edges.Company = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDocumentTags; query != nil {
		if err := _q.loadDocumentTags(ctx, query, nodes,
			func(n *Tag) { n.Edges.DocumentTags = []*DocumentTag{} },
			func(n *Tag, e *DocumentTag) { n.Edges.DocumentTags = append(n.Edges.DocumentTags, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TagQuery) loadCompany(ctx context.Context, query *CompanyQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Company)) error {
...
func (_q *TagQuery) loadDocumentTags(ctx context.Context, query *DocumentTagQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *DocumentTag)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(tag.DocumentTagsTable)
		s.Join(joinT).On(s.C(documenttag.FieldID), joinT.C(tag.DocumentTagsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(tag.DocumentTagsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(tag.DocumentTagsPrimaryKey[0]))
...
func (_q *TagQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCompany != nil {
			_spec.Node.AddColumnOnce(tag.FieldCompanyID)
		}
	}
