...
func (_c *SenderCreate) SetName(v string) *SenderCreate {
	_c.mutation.SetName(v)
	return _c
}

// SetEmail sets the "email" field.
func (_c *SenderCreate) SetEmail(v string) *SenderCreate {
	_c.mutation.SetEmail(v)
	return _c
}

// SetNillableEmail sets the "email" field if the given value is not nil.
func (_c *SenderCreate) SetNillableEmail(v *string) *SenderCreate {
	if v != nil {
		_c.SetEmail(*v)
	}
	return _c
...
func (_c *SenderCreate) SetID(v uuid.UUID) *SenderCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *SenderCreate) SetNillableID(v *uuid.UUID) *SenderCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *SenderCreate) AddDocumentIDs(ids ...uuid.UUID) *SenderCreate {
	_c.mutation.AddDocumentIDs(ids...)
	return _c
}

// AddDocuments adds the "documents" edges to the Document entity.
func (_c *SenderCreate) AddDocuments(v ...*Document) *SenderCreate {
...
func (_c *SenderCreate) Mutation() *SenderMutation {
	return _c.mutation
}

// Save creates the Sender in the database.
func (_c *SenderCreate) Save(ctx context.Context) (*Sender, error) {
	_c.defaults()
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *SenderCreate) SaveX(ctx context.Context) *Sender {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *SenderCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *SenderCreate) ExecX(ctx context.Context) {
...
func (_c *SenderCreate) sqlSave(ctx context.Context) (*Sender, error) {
...
func (_c *SenderCreate) createSpec() (*Sender, *sqlgraph.CreateSpec) {
	var (
		_node = &Sender{config: _c.config}
		_spec = sqlgraph.NewCreateSpec(sender.Table, sqlgraph.NewFieldSpec(sender.FieldID, field.TypeUUID))
	)
...
func (_c *SenderCreateBulk) Save(ctx context.Context) ([]*Sender, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*Sender, len(_c.builders))
...
func (_c *SenderCreateBulk) SaveX(ctx context.Context) []*Sender {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *SenderCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *SenderCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
